...
{
    [Test]
    public void DefaultConstructorShouldReturnAnEmptyErrorDictionary()
    {
    ...
    [Test]
    public void SingleValidationFailureShouldCreateASingleElementErrorDictionary()
    {
    ...
    [Test]
    public void MulitpleValidationFailureForMultiplePropertiesShouldCreateAMultipleElementErrorDictionaryEachWithMultipleValues()
    {
        var failures = new List<ValidationFailure>
        {
